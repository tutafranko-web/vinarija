    ...
    <div className="pt-24 pb-16">
      <div className="container-custom">
        <h1 className="text-4xl sm:text-5xl font-bold font-heading text-foreground text-center mb-3">
          {locale === "hr"
            ? "Naša Vina i Restoran"
            : "Our Wines and Restaurant"}
        </h1>
        <p className="text-lg text-muted-foreground text-center max-w-2xl mx-auto mb-12">
          {locale === "hr"
            ? "6 brandova kvalitetnih hvarskih vina i rooftop restoran s tradicionalnom dalmatinskom kuhinjom"
            : "6 quality Hvar wine brands and a rooftop restaurant with traditional Dalmatian cuisine"}
        </p>
              ...
              <div className="group bg-card rounded-2xl overflow-hidden border border-border hover:shadow-lg transition-all duration-300">
                <div className="grid sm:grid-cols-2">
                  <div className="relative h-64 sm:h-full min-h-[250px]">
                    <Image
                      src={wine.image}
                      alt={`${locale === "hr" ? wine.nameHr : wine.nameEn} -- ${wine.grape} -- Luviji vinarija Hvar`}
                      fill
          ...
          <ScrollReveal direction="left">
            <div className="relative h-[400px] rounded-2xl overflow-hidden">
              <Image
                ...
                alt="Rooftop terasa Luviji restorana s pogledom na grad Hvar"
                fill
